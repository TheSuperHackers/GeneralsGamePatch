...
if "%ThisArg1%"=="build" (
    ...
    xcopy /y    "%GameFilesDir%\Art\Textures\SAAmphibiousTransport.tga"   "%GeneratedBigFilesUnpackedDir%\%BigName%\Art\Textures\"
    xcopy /y    "%GameFilesDir%\Art\Textures\SAAmphibiousTransport_L.tga" "%GeneratedBigFilesUnpackedDir%\%BigName%\Art\Textures\"
